...
<head>
    ...
    <title>{{ config('app.name', 'GoSmart') }} | @yield('title')</title>
                    ...
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-info-wrapper-3">
                            ...
                            <div class="footer-address-furniture">
                                ...
                                <div class="footer-info-content3">
                                    <p><a href="#"> email@domain.com</a> <br><a href="#">
                                            domain@mail.info</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="copyright-furniture">
                            <p>Copyright © <a href="#">GoSmart</a> 2023 . All Right Reserved.
                            </p>
                        </div>
                    </div>
                </div>
