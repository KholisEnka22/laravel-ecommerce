                                    ...
                                    @forelse ($favorites as $favorite)
                                        ...
                                        <tr>
                                            <td class="product-remove">
                                                <form id="delete-fav"
                                                    action="{{ route('favorite.destroy', $favorite->id) }}" method="POST"
                                                    class="d-none">
                                                    @csrf
                                                    @method('delete')
                                                </form>
                                                <a href=""
                                                    onclick="event.preventDefault();document.getElementById('delete-fav').submit();"
                                                    class="delete"><i class="pe-7s-close"></i></a>
                                            </td>
                                            ...
                                            <td class="product-price-cart"><span
                                                    class="amount">{{ number_format($product->price) }}</span></td>
                                        </tr>
                                    @empty
                                        <tr>
