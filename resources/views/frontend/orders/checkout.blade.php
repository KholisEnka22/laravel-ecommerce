...
@section('content')
    ...
    <div class="breadcrumb-area pt-205 breadcrumb-padding pb-210"
        style="background-image: url({{ asset('frontend/assets/img/bg/bg.jpg') }})">
        <div class="container">
                            ...
                            <div class="row">
                                    ...
                                    <div class="checkout-form-list">
                                        ...
                                        <select name="city_id" id="city-id" value="{{ auth()->user()->city_id }}">
                                            @foreach ($cities as $id => $city)
                                                <option {{ auth()->user()->city_id == $id ? 'selected' : null }}
                                ...
                                <div class="col-md-6">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="number" name="postcode" placeholder="PostalCode..."
                                ...
                                <div class="col-md-6">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" name="email" readonly placeholder="Email..."
                                ...
                                <table>
                                        ...
                                        @forelse ($items as $item)
                                            ...
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-total">
                                                    <span
                                                        class="amount">{{ number_format(\Cart::get($item->id)->getPriceSum()) }}</span>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="cart-subtotal">
                                            ...
                                            <td><select id="shipping-cost-option" required
                                                    name="shipping_service"></select></td>
                                        </tr>
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span
                                                        class="total-amount">{{ number_format(\Cart::getTotal()) }}</span></strong>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
