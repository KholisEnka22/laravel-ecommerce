...
@section('content')
    <div class="breadcrumb-area pt-205 breadcrumb-padding pb-210"
        style="background-image: url({{ asset('frontend/assets/img/bg/breadcrumb.jpg') }})">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row pt-5">
                        ...
                        <div class="col-xl-4 col-lg-4">
                            ...
                            <address>
                                ID Transaksi: <span class="text-dark">#{{ $order->code }}</span>
                                <br>Tanggal Transaksi : {{ $order->order_date }}
                    ...
                    @if ($order->payment_status == 'unpaid')
                        <a href="{{ $order->payment_url }}" class="btn btn-info">Proceed to payment</a>
                    @endif
                </div>
            </div>
        </div>
